...
<div class="section-wrapper wf-section">
  ...
  <div class="contentwrapper w-container">
    <div class="w-layout-gr id domestic-violence-grid">
      <div class="practice-area-left-container">
        <div class="title-block">
          <div class="div-block-135 blog">
            ...
            <h3 data-text="t49de7a95" style="margin-top:0px !important; padding-top:0px !important;margin-bottom:0px !important;">Category: <?php single_cat_title( '', false ); ?></h2>
              <?php the_archive_title('<h3>','</h3>'); ?>
              <?php get_the_archive_description('<div>','</div>'); ?>
              <?php
          ...
          <?php get_template_part('template-parts/query/blog-archive') ?>

        ...
        <div class="practice-area-left-container">
          <div class="title-block">
            <div class="div-block-135 blog">
              ...
              <h3 data-text="t49de7a95" style="margin-top:0px !important; padding-top:0px !important;margin-bottom:0px !important;">Category: <?php single_cat_title();?></h2>
            </div>
            <div>
              <?php get_template_part('template-parts/query/blog-category') ?>
            </div>
          </div>
        </div>
